...
- [**config_template**](#leadr.boards.adapters.orm.BoardTemplateORM.config_template) (<code>[Mapped](#sqlalchemy.orm.Mapped)\[[dict](#dict)\[[str](#str), [Any](#typing.Any)\]\]</code>) –
...
####### `leadr.boards.adapters.orm.BoardTemplateORM.config_template`

```python
config_template: Mapped[dict[str, Any]] = mapped_column(JSONB, nullable=False, default=dict, server_default='{}')
```
...
- [**handle_list_boards**](#leadr.boards.api.board_routes.handle_list_boards) – Shared handler for listing boards.
...
```python
handle_list_boards(auth, service, pagination, account_id, code)
```
...
```python
list_boards_admin(auth, service, pagination, account_id=None, code=None)
```
...
```python
list_boards_client(auth, service, pagination, code=None)
```
...
- [**icon**](#leadr.boards.api.board_schemas.BoardCreateRequest.icon) (<code>[str](#str)</code>) –
...
- [**unit**](#leadr.boards.api.board_schemas.BoardCreateRequest.unit) (<code>[str](#str)</code>) –
...
- [**icon**](#leadr.boards.api.board_schemas.BoardResponse.icon) (<code>[str](#str)</code>) –
...
- [**unit**](#leadr.boards.api.board_schemas.BoardResponse.unit) (<code>[str](#str)</code>) –
...
- [**config_template**](#leadr.boards.api.board_template_schemas.BoardTemplateCreateRequest.config_template) (<code>[dict](#dict)\[[str](#str), [Any](#typing.Any)\] | None</code>) –
...
```python
config: dict[str, Any] | None = Field(default=None, description='Optional configuration for boards created from this template')
```

####### `leadr.boards.api.board_template_schemas.BoardTemplateCreateRequest.config_template`

```python
config_template: dict[str, Any] | None = Field(default=None, description='Optional template configuration for random generation')
```
...
- [**config_template**](#leadr.boards.api.board_template_schemas.BoardTemplateResponse.config_template) (<code>[dict](#dict)\[[str](#str), [Any](#typing.Any)\]</code>) –
...
```python
config: dict[str, Any] = Field(default_factory=dict, description='Configuration for boards created from this template')
```

####### `leadr.boards.api.board_template_schemas.BoardTemplateResponse.config_template`

```python
config_template: dict[str, Any] = Field(default_factory=dict, description='Template configuration for random generation')
```
...
- [**config_template**](#leadr.boards.api.board_template_schemas.BoardTemplateUpdateRequest.config_template) (<code>[dict](#dict)\[[str](#str), [Any](#typing.Any)\] | None</code>) –
...
####### `leadr.boards.api.board_template_schemas.BoardTemplateUpdateRequest.config_template`

```python
config_template: dict[str, Any] | None = Field(default=None, description='Updated config template')
```
...
- [**config_template**](#leadr.boards.domain.board_template.BoardTemplate.config_template) (<code>[dict](#dict)\[[str](#str), [Any](#typing.Any)\]</code>) –
...
```python
config: dict[str, Any] = Field(default_factory=dict, description='Configuration object for boards created from this template')
```

####### `leadr.boards.domain.board_template.BoardTemplate.config_template`

```python
config_template: dict[str, Any] = Field(default_factory=dict, description='Template configuration for random generation or variable substitution')
```
...
```python
create_board(account_id, game_id, name, icon, unit, is_active, sort_direction, keep_strategy, short_code=None, created_from_template_id=None, template_name=None, starts_at=None, ends_at=None, tags=None)
```
...
```python
list_boards(account_id=None, code=None, pagination=None)
```
...
```python
update_board(board_id, name=None, icon=None, short_code=None, unit=None, is_active=None, sort_direction=None, keep_strategy=None, created_from_template_id=None, template_name=None, starts_at=None, ends_at=None, tags=None)
```
...
```python
create_board_template(account_id, game_id, name, repeat_interval, next_run_at, is_active, name_template=None, series=None, config=None, config_template=None)
```
...
- **config_template** (<code>[dict](#dict)\[[str](#str), [Any](#typing.Any)\] | None</code>) – Optional template configuration for random generation.
...
```python
update_board_template(template_id, name=None, name_template=None, series=None, repeat_interval=None, config=None, config_template=None, next_run_at=None, is_active=None)
```
...
- **config_template** (<code>[dict](#dict)\[[str](#str), [Any](#typing.Any)\] | None</code>) – New config template, if provided.
...
```python
SORTABLE_FIELDS = {'id', 'name', 'short_code', 'created_at', 'updated_at'}
```
...
- <code>[str](#str)</code> – 8-character uppercase alphanumeric code (e.g., 'A7B3X9K2').
...
- <code>[str](#str)</code> – Unique 8-character short code guaranteed not to exist in database.
