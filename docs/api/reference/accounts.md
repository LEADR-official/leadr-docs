...
- [**list_accounts**](#leadr.accounts.api.account_routes.list_accounts) – List accounts with pagination.
...
```python
list_accounts(service, auth, pagination)
```
...
- [**slug**](#leadr.accounts.api.account_schemas.AccountCreateRequest.slug) (<code>[str](#str)</code>) –
