...
- All games on the team's account
- All boards on each game
- Creating new games and boards
- Editing existing games and boards
- Viewing and resolving score flags

Your API key is automatically generated and saved to your local config file, just like when registering a new account.

## What's Next

- **[Create a Game](./create-game.md)** - Set your game up in the LEADR app
- **[Create a Board](./create-board.md)** - Create boards with the LEADR app
