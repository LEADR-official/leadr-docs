...
### Platform Sync
Import and synchronize with existing Steam Leaderboards and Unity Gaming Services. Migrate your established leaderboards without losing history, or run LEADR alongside platform-specific boards for expanded functionality. Unify your player data across multiple platforms while maintaining compatibility with existing integrations.
...
Have ideas for what should come next? Join the discussion on [Discord](https://discord.gg/RMUukcAxSZ) or [Reddit](https://www.reddit.com/r/LEADR/) - your feedback shapes what we build.
